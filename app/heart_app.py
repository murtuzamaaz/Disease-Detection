...
def display():
    ...
    try:
        with open(r"C:\Users\Maaz\Desktop\Disease-Prediction-main\predictors\heart_scaler.pkl", 'rb') as scaler_file:
            scaler = pickle.load(scaler_file)

        with open(r"C:\Users\Maaz\Desktop\Disease-Prediction-main\predictors\heart_knn.pkl", 'rb') as knn_file:
