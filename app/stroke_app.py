...
def display():
    ...
    try:
        with open(r'C:\Users\Maaz\Desktop\Disease-Prediction-main\predictors\stroke_encoder.pkl', 'rb') as encoder_file:
            encoder = pickle.load(encoder_file)

        with open(r'C:\Users\Maaz\Desktop\Disease-Prediction-main\predictors\stroke_scaler.pkl', 'rb') as scaler_file:
            scaler = pickle.load(scaler_file)

        with open(r'C:\Users\Maaz\Desktop\Disease-Prediction-main\predictors\stroke_knn.pkl', 'rb') as model_file:
